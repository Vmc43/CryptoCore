...
int CopyH2V(int mode, int precision, int src_address, int dst_address)
{

	// opcode for cp h2v instruction
	u32 opcode = 0x6;	
	u32 sec_calc = 0x0;
	...
	if (mode==1){
		switch(precision){
			case 192: prec_byte = 0x0;
			case 224: prec_byte = 0x1;
			case 256: prec_byte = 0x2;
			case 320: prec_byte = 0x3;
			case 384: prec_byte = 0x4;
			case 512: prec_byte = 0x5;
			case 768: prec_byte = 0x6;
			case 1024: prec_byte = 0x7;
			case 1536: prec_byte = 0x8;
			case 2048: prec_byte = 0x9;
			case 3072: prec_byte = 0xA;
			case 4096: prec_byte = 0xB;
			case 448: prec_byte = 0xD;
			default: prec_byte = -1;
			}}
	else if (mode==0){
		switch(precision){
			case 131: prec_byte = 0x0;
			case 163: prec_byte = 0x1;
			case 176: prec_byte = 0x2;
			case 191: prec_byte = 0x3;
			case 193: prec_byte = 0x4;
			case 208: prec_byte = 0x5;
			case 233: prec_byte = 0x6;
			case 239: prec_byte = 0x7;
			case 272: prec_byte = 0x8;
			case 283: prec_byte = 0x9;
			case 304: prec_byte = 0xA;
			case 359: prec_byte = 0xB;
			case 368: prec_byte = 0xC;
			case 409: prec_byte = 0xD;
			case 431: prec_byte = 0xE;
			case 571: prec_byte = 0xF;
			default: prec_byte = -1;
			}}
	
	if (prec_byte==-1)
		// Falls undefinierter Adressierungsgröße
		return -1;


	// MWMAC_RAM Adresse
	u32 *dest = &MWMAC_RAM_ptr + dst_address;
	u32 *src = &MWMAC_RAM_ptr + src_address;
	...
	dest_value = ioread32(dest);
	src_value = ioread32(dest);

	// kopieren hat funktioniert
